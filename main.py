...
import cv2 # processamento de imagens e vídeo
import mediapipe as mp # rastreamento de mãos
import numpy as np # computação numérica
from keras.models import load_model # execução de redes neurais
from collections import deque # organização de estrutura de dados
